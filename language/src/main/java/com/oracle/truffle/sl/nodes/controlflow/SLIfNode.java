...
public final class SLIfNode extends SLStatementNode {
     ...
     * {@link com.oracle.truffle.sl.rev.MySLIfNodeT executing the condition} can lead to a type error.
     */
    @Child
    ...
    public SLStatementNode getThenPartNode() {
        return thenPartNode;
    }

    public SLStatementNode getElsePartNode() {
        return elsePartNode;
    }
